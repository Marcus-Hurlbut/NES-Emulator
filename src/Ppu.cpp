...
void Ppu::fetchSprites()
{
    ...
    switch (thisCycle)
    {
        ...
        case 7:
            ...
            {
                // Update lo & hi bits to shift register
        ...
        case -1 ... 239:
            ...
            switch(cycles)
            {
                ...
                case 1 ... 256:
                    ...
                    // Place fetched data into internal latches - Every Cycle after first
                    if (cycles > 1)
                    {
                    ...
                    // Sprite Initialization and Copying from pOAM
                    if (scanLine >= 0)
                    {
